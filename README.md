...
### Current scripts:
Generating  k number of random samples and observing as k gets large, results are distributed normally.
...
ODE solver, solves 1<sup>st</sup> and 2<sup>nd</sup> order Differential equations using a module, and add a visual model of a solution to the ODE with __given initial conditions__. At some point, I will also cover **partial differential equations**.
 ...
 ## AI usage:
I do not rely solely on generative AI to write code, I use it for debugging code and for planning code projects with  
